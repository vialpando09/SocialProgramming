namespace Telerik.Web.Mvc.UI.Tests
{
    ...
    public class PercentTextBoxRenderingTests
    {
        ...
        [Fact]
        public void Render_should_output_PercentTextBox_start()
        {
